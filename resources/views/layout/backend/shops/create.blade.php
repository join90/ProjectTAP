...
@section('content')
    ...
    @endif
    <div class="row">
        {!! Form::open(['method'=>'POST', 'action' => 'SellerController@store', 'files' => true]) !!}
            <div class="col-md-6 col-sm-12">
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('nomeNegozio', Input::old('nomeNegozio'), ['class' => 'form-control']) !!}
                </div>
                <div class="form-group">
                    {!! Form::label('descrizione', 'Descrizione') !!}
                    {!! Form::textarea('descrizione', Input::old('descrizione'), ['class' => 'form-control']) !!}
                </div>
                <div class="form-group">
                    {!! Form::label('piva', 'P.Iva') !!}
                    {!! Form::text('piva', Input::old('piva'), ['class' => 'form-control']) !!}
                </div>
                <div class="form-group">
                    {!! Form::label('GiorniApertura', 'Giorni apertura') !!}
                    {!! Form::text('GiorniApertura', Input::old('GiorniApertura'), ['class' => 'form-control']) !!}
                </div>
                <div class="form-group">
...
<script src="https://maps.googleapis.com/maps/api/js?libraries=places&?key=AIzaSyC6ruGEvcF_Un1z7bTpdNMhzL_cMD7Leiw&callback=initAutocomplete" async defer></script>
@endsection  