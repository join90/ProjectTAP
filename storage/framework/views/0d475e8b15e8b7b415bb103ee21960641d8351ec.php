    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">
                Modifica <i><?php echo e($shop->nomeNegozio); ?></i>
            </h1>
        </div>
    </div>
    <!-- /.row -->
...
<?php $__env->startSection('content'); ?>
    ...
    <?php endif; ?>
    <div class="row">
        <?php echo Form::model($shop, ['method' => 'PUT', 'action' => ['SellerController@update', $shop->id], 'files' => true]); ?>
            ...
            <div class="col-md-6 col-sm-12">
                ...
                <div class="form-group">
                    ...
                    <?php echo Form::text('nomeNegozio', null, ['class' => 'form-control']); ?>

                </div>
                <div class="form-group">
                    <?php echo Form::label('descrizione', 'Descrizione'); ?>

                    <?php echo Form::textarea('descrizione', null, ['class' => 'form-control']); ?>

                </div>
                <div class="form-group">
                    <?php echo Form::label('piva', 'P.Iva'); ?>

                    <?php echo Form::text('piva', null, ['class' => 'form-control']); ?>

                </div>
                <div class="form-group">
                    <?php echo Form::label('GiorniApertura', 'Giorni apertura'); ?>

                    <?php echo Form::text('GiorniApertura', null, ['class' => 'form-control']); ?>

                </div>
                <div class="form-group">
                    <?php echo Form::label('OrariApertura', 'Orari apertura'); ?>

                    <?php echo Form::text('OrariApertura', null, ['class' => 'form-control']); ?>
            ...
            <div class="col-md-6 col-sm-12">
                ...
                <div class="form-group">
                    ...
                    <?php echo Form::text('longitudine', null, ['class' => 'form-control', 'readonly']); ?>
